...
*/
int get_number_compatible(char* config,char* word_ref,unsigned int size_curr_dico, char** word_array,char* marquage_word_ref, int N, char* test)
{
    int count = 0;
...
*/
double get_entropy(char* word_ref, char** word_array, unsigned int size_curr_dico, char** config_array, int N, char* test)
{
...
*/
char* get_best_word(char** word_array, char** config_array, int N, unsigned int size_curr_dico, char* test)
{
...
*/
struct Array_and_size* create_new_word_array(char* word_ref, char* config, char** word_array, unsigned int size_dico,int N, char* test)
{
...
{
    char** word_array = load_file(fname,size_dico);
    ...
    char* best_word="aaaaa";
    char* best_word_old="bbbbb";
    printf("le meilleur mot à jouer est : RAIES\n");
    char* config_answer=analyse("RAIES",secret_word,N);
    printf("config obtenue: %s\n\n",config_answer);
    struct Array_and_size *new_word_array_and_size = create_new_word_array("RAIES",config_answer,word_array,size_dico,N, test);
